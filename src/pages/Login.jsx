...
const Login = () => {
  ...
  <div className='lg:w-1/3 shadow-lg border rounded-lg h-[80vh] p-4 flex flex-col items-left md:w-full'>
    ...
    <div className='flex justify-center items-center'>
        <span className='font-thin mb-8'>------------- or Sign in with Email ------------- </span>
    </div>
    <form className='mt-4 flex flex-col gap-y-4'>
      <label className='w-full'>
        <p className='mb-2 text-[0.875rem] leading-[1.375rem] text-black'>Email Address <sup className='text-[#991b1b]'>*</sup></p>
      <input
      required
      type='text'
      name='email'
      ...
      <label className='relative'>
        <p className='mb-2 text-[0.875rem] leading-[1.375rem] text-black'>Enter Password<sup className='text-[#991b1b]'>*</sup></p>
      <input
      required
